<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonationINFO.aspx.cs" Inherits="MyProject6.DonationINFO" %>
...
<%--                </div>--%>
            ...
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="ServiceID" DataSourceID="SqlDataSource3" CssClass="table table-striped donmar"  OnRowUpdating="GridView3_RowUpdating">
                <Columns>
                    <asp:TemplateField HeaderText="ID" InsertVisible="False" SortExpression="ServiceID">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Image" SortExpression="Image">
                        <EditItemTemplate>
                            <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("Image") %>' Height="40px" Width="80px"/>
                        </EditItemTemplate>
                        <ItemTemplate>
                   ...
                   <asp:CommandField ShowEditButton="True" ButtonType="Button" >
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="ServiceID" DataNavigateUrlFormatString="DonationDetails.aspx?id={0}" HeaderText="Details" Text="showmore" />
                </Columns>
